 ...
 */
final class Version20191217170351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE common.app_user ALTER sexe TYPE VARCHAR(255)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE common.app_user ALTER sexe TYPE VARCHAR(10)');
    }
}
