 ...
 */
final class Version20191217175249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gestion_registre.registre ADD previous_status VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gestion_registre.registre DROP previous_status');
    }
}
