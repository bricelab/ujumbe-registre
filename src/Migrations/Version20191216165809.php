 ...
 */
final class Version20191216165809 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE common.app_user ALTER email_auth_enabled SET DEFAULT \'false\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE common.app_user ALTER email_auth_enabled DROP DEFAULT');
    }
}
